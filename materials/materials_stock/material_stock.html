        ...
        <section class="announcement">
            ...
            <div class="production_check">
                ...
                <form class="production_searchbox">
                    <label for="employee_number">자재 이름:</label>
            ...
            <div class="material">
                <table class="material_table" id="">
                    ...
                    <tbody>   
                        ...
                        <tr>
                            <td colspan="7">조회된 추가 데이터가 없습니다.</td>
                        </tr>   
                    </tbody>
            ...
            <section class="bt_section">
                ...
                <a href="/materials/materials_stock/deleveryupdate.html">
                    <button class="mt_button" type="button" >
                    출고등록</button>
                </a>
                <a href="/materials/materials_stock/receiveupdate.html">
                    <button class="mt_button" type="button" >
                    입고등록</button>
                </a>
            </section>
