...
<body>
    ...
    <section class="content">
        ...
        <div class="hrm_main">
            ...
            <div class="container hrm_am">
                <div class="right-panel hrm_am">
                    <div class="date-time hrm_am">
                        <p id="current-time"></p>
                        <p id="current-date"></p>
                    </div>
                    <ul class="menu-list hrm_am">
                        <li><a href="#">전체 조회</a><span class="menu-count hrm_am">(5)</span></li>
                        <li><a href="#">정상 근로일</a><span class="menu-count hrm_am">(3)</span></li>
                        <li><a href="#">미처리</a><span class="menu-count hrm_am">(2)</span></li>
                        <li><a href="#">실제 출퇴근 등록일</a><span class="menu-count hrm_am">(7)</span></li>
                    </ul>
                </div>
                <h2>근무 일정</h2>
                <hr width="800px">
                <table class="hrm_am">
                    <tr class="hrm_am">
                        <th class="hrm_am">날짜</th>
                        <th class="hrm_am">출근 시간</th>
                        <th class="hrm_am">퇴근 시간</th>
                        <th class="hrm_am">작업 시간</th>
                        <th class="hrm_am">조치</th>
                    </tr>
                    <!-- 근무 일정 데이터를 여기에 추가 -->
                </table>
                <button class="btn hrm_am">근태 기록 입력</button>
            </div>
            <script src="hrm_am.js"></script>
        </div>
