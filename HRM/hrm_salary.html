...
<body>
    ...
    <section class="sidebar">
        ...
        <section class="content">
            ...
            <div class="hrm_salary">            
                <div class="hrm_salary_navbar">
                    <a href="#">급여자 명단</a>
                    <a href="#">부서별 명단</a>
                    <div class="hrm_salary_dropdown">
                        <button class="hrm_salary_dropbtn">Services</button>
                        <div class="hrm_salary_dropdown-content">
                            <a href="#">Service 1</a>
                            <a href="#">Service 2</a>
                            <a href="#">Service 3</a>
                        </div>
