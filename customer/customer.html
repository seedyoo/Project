    ...
    <section class="sidebar">
        ...
        <section class="announcement">
            <div class="production_check">
                ...
                <h2 class="title2">고객정보</h2>

                <hr width="800px">
                
                <form class="production_searchbox">
                    <label for="employee_number"> 고객 성함:</label>
            ...
            <div class="material">
                <table class="material_table" id="">
                    ...
                    <tbody>   
                        <tr id="empty">
                            <td>001</td> <td>가나다</td> <td>xxxxxx-xxxxxxx</td>
                            <td>abcd@mail.com</td> <td>010-1111-2222</td> 
                            <td><button onclick="show_address()">위치</button></td>
                            <td>7</td>
                        </tr>
                        <tr id="empty">
                        ...
                        <tr>
                            <td colspan="8">조회된 추가 데이터가 없습니다.</td>
                        </tr>   
                    </tbody>
                    
                </table>
                <!-- float:right 적용으로 오른쪽부터 왼족으로 나열됨 -->
                
                <a href="/customer/customerupdate.html">
                    <button class="mt_button" type="button">
                    등록하기</button></a>
